...
/// Page de profil pour les producteurs (PRODUCTEUR)
/// Affiche les statistiques de parcelles, rendement, etc.
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            user != null ? "${user.nom} ${user.prenoms}" : "Producteur",
            style: const TextStyle(
              color: Colors.white,
              fontSize: 22,
              fontWeight: FontWeight.bold,
      ...
      child: Column(
        ...
        children: [
              ...
              BlocBuilder<ParcelleBloc, ParcelleState>(
                builder: (context, state) {
                  ...
                  if (state is ParcelleLoaded) {
                    ...
                    final total = state.parcelles.fold(
                      0.0,
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _buildStatItem("N/A", "Rendement", Colors.orange),
              _buildStatItem("N/A", "Mois d'usage", Colors.purple),
            ],
          ),
        ],
      ),
